...
<body>
	<div class="staff-shell">
		<aside class="staff-sidebar">
			...
			<button class="logout-btn" id="adminLogoutBtn" style="margin-top:auto;background:#fff;color:var(--primary);border:none;border-radius:24px;padding:10px 20px;cursor:pointer;">Sign Out</button>
		</aside>
